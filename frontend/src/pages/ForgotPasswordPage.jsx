...
const ForgotPasswordPage = () => {
    ...
    return (
        ...
        >
                ...
                {!isSubmitted ? (
                    <form onSubmit={handleSubmit}>
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="w-full py-3 px-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold rounded-lg shadow-2xl hover:from-green-600 hover:to-emerald-700 transition duration-200"
                            type="submit"
                        >
            ...
            <div className="px-8 py-4 bg-black/10 backdrop-blur-xl shadow-inner border-t border-white/20 flex justify-center">
